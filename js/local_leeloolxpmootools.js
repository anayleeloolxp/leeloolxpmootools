require(["jquery"], function ($) {
  ...
  $(document).ready(function () {
    let mootoolsleeloourl = $("#leeloolxpmootools-js-vars").data(
      "mootoolsleeloourl"
    );
    ...
    document.getElementById("local_leeloolxpmootools_frame").innerHTML =
      '<iframe src="' +
      leeloolxpssourl +
      '" class="leeloolxpmootools_frame"></iframe>';
